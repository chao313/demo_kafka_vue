        ...
        <div class="login-main">
            ...
            <el-form class="login-form" autoComplete="on" :model="loginForm" ref="loginForm"
                ...
                <el-form-item prop="password" class="mt30">
                    ...
                    <input class="login-input" name="password" :type="passwordType" @keyup.enter.native="handleLogin"
                ...
                <el-button class="login-btn" @click.native.prevent="handleLogin">登&nbsp;&nbsp;&nbsp;录</el-button>
            </el-form>
        </div>
            ...
            handleLogin() {
                ...
                this.$refs.loginForm.validate(valid => {
                        if (valid) {
                            ...
                            params.append('name', self.loginForm.loginId);
                            params.append('passwd', self.loginForm.password);
                            self.$http.postUseToken(self.api.userLogin, params, {
                                headers: {
